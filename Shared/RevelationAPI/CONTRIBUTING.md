...
The RevelationAPI maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/RahulKatariya/RevelationAPI/blob/master/CODE_OF_CONDUCT.md) for details.
