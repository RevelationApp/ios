...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RevelationAPI/RevelationAPI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RevelationDomain/RevelationDomain.framework"
fi
